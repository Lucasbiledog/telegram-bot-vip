...
async def on_startup():
    ...
    job_queue.run_daily(send_preparation_message, time=dt.time(hour=12, minute=25, tzinfo=timezone), name="prep_msg")

    # Agendar envio do asset às 12:26
    job_queue.run_daily(send_daily_asset, time=dt.time(hour=12, minute=26, tzinfo=timezone), name="daily_asset")
